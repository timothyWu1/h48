...
<?php
 ...
 while( $recherche = mysqli_fetch_array($q)){?>
  ...
  <div class="card-body" style="display: contents;">
    <p class="card-text"><?php echo $recherche['Composant'] ; ?></p>
    <a href="supprimer_composant.php?IDtable=<?= $recherche['id'] ?>" class="btn btn-danger" >Supprimer</a><a href="#" class="btn btn-success" >Ajouter</a>
  </div>
</div>
   <?php } ?>
    </div>
