...
<body id="page-top">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="ambiance.php">Ambiance</a>
  ...
  <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experience">
      <div class="w-100">
        ...
        <h2 class="mb-5">Familles de Produits</h2>
...
<?php
 ...
 while( $recherche = mysqli_fetch_array($q)){?>
  ...
  <div class="card-body" style="display: contents;">
    <p class="card-text"><?php echo $recherche['Familles_de_Produits'] ; ?></p>
    <a href="supprimer_familles.php?IDtable=<?= $recherche['id'] ?>" class="btn btn-danger" >Supprimer</a><a href="#" class="btn btn-success" >Ajouter</a>
  </div>
</div>
   <?php } ?>
    </div>
